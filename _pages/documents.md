...
The following attribute types are available:
  ...
  memo           | Generic text values which are intended for large or formatted text values.<br>Memo attributes are automatically indexed for textual searching. | textArea | ![](../assets/images/documents/image74.png)
...
---
**Next [Chapter 9: Converters](./../_pages/converters.md)**  
**Previous [Chapter 7: Modules](./../_pages/modules.md)**
